<div class="list-group panel">
    ...
    {{--  --}}
    <a href="#" class="item-sidebar collapsed {{($item['item_sidebar'] == 'groups') ? 'active' : ''}}" data-parent="#sidebar">
        <i class="fa fa-users"></i> 
        <span class="hidden-sm-down">Grupos</span>
    </a>

    {{--  --}}
    <a href="#" class="item-sidebar collapsed {{($item['item_sidebar'] == 'files') ? 'active' : ''}}" data-parent="#sidebar">
    ...
    <a href="#" class="item-sidebar collapsed {{($item['item_sidebar'] == 'posts') ? 'active' : ''}}" data-parent="#sidebar">
        <i class="fa fa-file-text"></i> 
        <span class="hidden-sm-down">Entradas</span>
    </a>

    {{--  --}}
    <a href="#" class="item-sidebar collapsed {{($item['item_sidebar'] == 'pages') ? 'active' : ''}}" data-parent="#sidebar">
        <i class="fa fa-files-o"></i> 
        <span class="hidden-sm-down">Paginas</span>
    </a>

    {{--  --}}
    <a href="#" class="item-sidebar collapsed {{($item['item_sidebar'] == 'categories') ? 'active' : ''}}" data-parent="#sidebar">
    ...
    {{-- Settings  --}}
    <a href="#" class="item-sidebar collapsed {{($item['item_sidebar'] == 'configutration') ? 'active' : ''}}" data-parent="#sidebar">
        <i class="fa fa-cog"></i> 
